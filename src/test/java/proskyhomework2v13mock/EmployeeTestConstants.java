...
public class EmployeeTestConstants {
    ...
    public static final Employee MAX_SALARY_EMPLOYEE = new Employee(FIRST_NAME, LAST_NAME, SALARY, DEPARTMENT_ID);
    ...
    public static final Employee DIFFRENT_DEPARTMENT_EMPLOYEE = new Employee(FIRST_NAME2, LAST_NAME2, SALARY, BAD_DEPARTMENT_ID);
